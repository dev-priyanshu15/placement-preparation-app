...
const About = () => {
  ...
  no further than EduSphere, the premier programming community
  dedicated to helping new programmers achieve their goals and reach
  their full potential.
  <br />
  <br />
  As the founder and CEO of EduSphere, I know firsthand the challenges
  that come with learning and growing in the programming industry.
  That&apos;s why I created EduSphere &ndash; to provide new
  ...
  that&apos;s just the beginning. Our affordable coding courses are designed to
  give you the high-quality education you need to succeed in the
  industry, without breaking the bank.
  <br />
  <br />
  At EduSphere, we believe that price should never be a barrier to
  ...
  <br />
  <br />
  But EduSphere is more than just a community &ndash; we&apos;re a
  ...
  or looking to take your coding skills to the next level.
  <br />
  <br />
  With EduSphere by your side, there&apos;s nothing standing between
  ...
  affordable coding courses, informative videos, and supportive community, the
  sky&apos;s the limit.
</p>

        <br />
        <span className="text-[22px]">Priyanshu & Shifa</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of EduSphere
        </h5>
        <br />
        <br />
        <br />
